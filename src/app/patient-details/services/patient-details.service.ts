...
import { Firestore, doc, getDoc, collection, query, where, orderBy, getDocs, limit } from '@angular/fire/firestore';
...
import { PatientHealthData } from '../../models/patient-health-data.model';
